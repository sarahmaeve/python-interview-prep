...
class TestPaymentProcessor(unittest.TestCase):
    ...
    def test_successful_payment(self):
        ...
        gateway = None  # replace this line with your mock setup
    ...
    def test_international_payment_converts_currency(self):
        ...
        gateway = None  # replace with your mock setup
        result = None   # replace — call process_international_payment inside a patch.object context
    ...
    def test_batch_processes_all_payments(self):
        ...
        # Note: when side_effect is a list, each call consumes the next item.
        # Exception instances in the list are raised; other values are returned.
        gateway = None  # replace this line with your mock setup
    ...
    def test_exchange_rate_with_context_manager_patch(self):
        ...
        rate = None  # replace — all work happens inside a 'with patch(...)' block
